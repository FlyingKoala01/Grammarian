      ...
      <I18nProvider locale={appLocale}>
        <main className="min-h-screen px-6 py-10 text-slate-950">
          <section className="mx-auto flex min-h-[70vh] max-w-4xl items-center justify-center">
            <div className="rounded-[2rem] border border-white/80 bg-white/85 px-8 py-10 text-center shadow-[0_25px_90px_rgba(15,23,42,0.08)] backdrop-blur">
        ...
        <SidebarInset>
          <main className="min-h-screen p-3 lg:p-4">
            <div className="flex min-h-[calc(100vh-1.5rem)] flex-col gap-3 lg:min-h-[calc(100vh-2rem)]">
              <div className="flex flex-col gap-2 rounded-[1.1rem] border border-white/80 bg-white/80 p-2 shadow-sm lg:hidden sm:flex-row sm:items-center">
